...
export default function Socialmedia() {
  return (
    <div className='fixed right-10 z-10 top-[450px] flex flex-col items-center'>
      {/* WhatsApp Icon */}
      <a
      ...
      >
        <motion.button
          ...
          className="bg-green-500 text-white font-semibold py-4 px-6 rounded-full shadow-md text-lg mb-4" // Reduced margin-bottom
        >
      ...
      >
        <motion.button
          ...
          transition={{ duration: 0.3 }}
          className="bg-gray-500 text-white font-semibold py-4 px-6 rounded-full shadow-md text-lg flex items-center justify-center"
        >
