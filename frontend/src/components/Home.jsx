...
// const media = [
//   { type: 'image', src: 'https://www.nrimb.com/assets/images/g-img5.jpg' },
//   { type: 'video', src: "https://www.youtube.com/watch?v=BO8U6IvKvqA" },
//   { type: 'image', src: 'https://i.pinimg.com/736x/f6/ac/fa/f6acfa98187ceb14dc5f7d7fcf5b2ce7.jpg' },
//   { type: 'video', src: 'https://example.com/video2.mp4' },
//   { type: 'image', src: 'https://i0.wp.com/moviegalleri.net/wp-content/uploads/2022/06/director-vignesh-shivan-actress-nayanthara-marriage-photos-hd-wedding-photos.jpg?resize=2500%2C2500&ssl=1' },
//   { type: 'video', src: 'https://example.com/video1.mp4' },
//   { type: 'image', src: 'https://5.imimg.com/data5/ANDROID/Default/2022/7/GI/NL/OS/41037327/product-jpeg-500x500.jpg' },
//   { type: 'video', src: 'https://example.com/video2.mp4' }
//   // Add more items here...
// ];
  ...
  <div className="relative z-10 text-white">
    ...
    <h4 className="relative text-[4vw] md:text-[25px] left-[10vw] md:left-[100px] bottom-[5vw] md:bottom-[60px]">
      ...
      <div className='w-full h-12 bg-gradient-to-r from-amber-600 to-amber-900 flex items-center justify-center uppercase text-white text-2xl tracking-wider font-bold'>
          <marquee behavior="alternate" direction="" scrollAmount="12">{status ? status.message : ''}</marquee>
      </div>
    {/* addstatus */}
...
<div className="container mx-auto p-4">
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg group">
      <img
        src="https://www.nrimb.com/assets/images/g-img5.jpg"
        alt="Matrimony 1"
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg group">
      <img
        src="https://i0.wp.com/moviegalleri.net/wp-content/uploads/2022/06/director-vignesh-shivan-actress-nayanthara-marriage-photos-hd-wedding-photos.jpg?resize=2500%2C2500&ssl=1"
        alt="Matrimony 2"
        className="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"
      />
      <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg group">
      <img
        src="https://i.pinimg.com/736x/f6/ac/fa/f6acfa98187ceb14dc5f7d7fcf5b2ce7.jpg"
        alt="Matrimony 3"
        className="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"
      />
      <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg group">
      <img
        src="https://www.nrimb.com/assets/images/couple-img2.jpg"
        alt="Matrimony 4"
        className="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"
      />
      <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
...
<div className="container mx-auto p-4">
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-center items-center">
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg">
      <iframe
        className="w-full h-64 md:h-80 lg:h-96 max-w-md"
        src="https://www.youtube.com/embed/LBtDzmOe5oI?si=93x5lVP7QjZ7jv5-"
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg">
      <iframe
        className="w-full h-64 md:h-80 lg:h-96 max-w-md"
        src="https://www.youtube.com/embed/pC7hlK8F4Fw"
        title="YouTube video player"
        frameBorder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        referrerPolicy="strict-origin-when-cross-origin"
    ...
    <div className="relative overflow-hidden rounded-lg shadow-lg">
      <iframe
        className="w-full h-64 md:h-80 lg:h-96 max-w-md"
        src="https://www.youtube.com/embed/2gII9YfRxVw"
        title="YouTube video player"
        frameBorder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        referrerPolicy="strict-origin-when-cross-origin"
