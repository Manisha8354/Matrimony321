...
export default function Payment() {
  ...
  let {auth} = useContext(UserContext)
    ...
    async function handleClick(e) {
        e.preventDefault()
        await axios.post('https://actl.co.in/api/paymentSave', { amount, upi, email })
    ...
    return (
        <div className='h-[150vh] bg-gray-400 relative'>
            <div className='mt-[120px] absolute w-full text-center'>
                ...
                <div className='flex flex-col-reverse w-full justify-center items-center  mt-12'>
                    <div className='h-[500px] w-[400px] bg-gradient-to-r from-amber-600 to-amber-900'>
                        ...
                        <div className=''>
                            <form action="" onSubmit={handleClick} method='post' className='flex flex-col text-2xl justify-center items-center mt-8 text-white'>
                                ...
                                <input type="text" className='rounded px-2 w-3/4 h-8 mt-2 mb-4 text-sm text-black' placeholder='Enter Your Email' value={email}/>
